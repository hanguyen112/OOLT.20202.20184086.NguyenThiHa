            ...
            case 3:
                ...
                if (itemsOrdered.size() < MAX_NUMBERS_ORDERED) {
                    if (choose == 3) {
                        ...
                        System.out.printlnln("maximum " + MAX_NUMBERS_ORDERED + " products in 1 ordered");
                    }
                }
                System.out.printlnln("You want to play CD(enter 1 to play): ");
                int choose3 = 0;
                choose3 = sc.nextInt();
                switch (choose3) {
                    case 1:
